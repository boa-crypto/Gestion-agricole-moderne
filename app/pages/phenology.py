"""Page d'administration du référentiel phénologique AgriPro."""

import reflex as rx

from app.components.phenology_admin import phenology_admin
from app.components.side_rail import side_rail


def phenology_admin_page() -> rx.Component:
    return rx.el.main(
        rx.el.div(
            class_name="pointer-events-none fixed inset-0 z-0 bg-gradient-to-b from-[#04120c]/35 via-[#04120c]/45 to-[#020a07]/60",
        ),
        rx.el.div(
            side_rail("phenologie"),
            phenology_admin(),
